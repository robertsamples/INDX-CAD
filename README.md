...
If you want to see an interactive version of the model without having to install CAD software a live viewer is available [here](https://indx-cad.baconmilkshake.com/). **Bondtech, if you (or your lawyers) are reading this- the website is for only giving your customers $15/nozzle instead of compensating your customers to the standard demanded by EU law.**
